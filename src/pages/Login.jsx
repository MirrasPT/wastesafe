            ...
            <div className="w-[95%] max-w-[450px]">
                <div className="bg-white p-8 rounded-[40px] shadow-lg border border-gray-100 relative overflow-hidden">
                    ...
                    <div className="text-center mb-10 relative z-10">
                        <h1 className="text-3xl font-bold text-[#355130] mb-3">Bem-vindo de volta!</h1>
                        <p className="text-gray-500 text-lg">Insira os seus dados para aceder à sua conta.</p>
                    </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between pt-2 gap-4">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <span className="text-sm text-gray-500">Manter sessão iniciada</span>
                                </label>
                    ...
                    <div className="mt-8 text-center relative z-10">
                        <p className="text-gray-500">
                            Não tem conta? <Link to="/registar" className="font-bold text-[#355130] hover:underline">Registar agora</Link>
                        </p>
                    </div>
